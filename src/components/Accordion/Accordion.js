                ...
                acord.push(
                    <Accordion defaultActiveKey="0">
                        <Card>
                            ...
                            <Accordion.Collapse eventKey="1">
                                <div >
                                    <Card.Body style={{ backgroundImage: ` linear-gradient( rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4) ), url(${chattaPics[i]})` }} className={classes.body}>{SpeciesData.chatta[i].info}</Card.Body>                                    </div>
                            </Accordion.Collapse>
                        </Card>
                    </Accordion>
                );
